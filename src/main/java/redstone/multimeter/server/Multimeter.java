...
*/
	...
	public void logBlockEvent(World world, int x, int y, int z, int type, int depth, BlockEventStatus status) {
		tryLogEvent(world, x, y, z, EventType.BLOCK_EVENT, (status.id() << 29) | (depth << 4) | type);
	}
