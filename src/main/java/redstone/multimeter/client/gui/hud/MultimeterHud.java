...
public class MultimeterHud extends AbstractParentElement {
	...
	public void init() {
		...
		this.playPauseButton = new TransparentButton(this.client, 0, 0, 9, 9, () -> !onScreen ^ paused ? "\u23f5" : "\u23f8", () -> Tooltip.of(TextUtils.formatKeybindInfo(Keybinds.PAUSE_METERS)), button -> {
			togglePaused();
			return true;
		});
		this.fastBackwardButton = new TransparentButton(this.client, 0, 0, 9, 9, () -> getStepSymbol(false, Screen.isControlDown()), () -> Tooltip.of(TextUtils.formatKeybindInfo(Keybinds.STEP_BACKWARD, new Object[] { Keybinds.SCROLL_HUD, "scroll" })), button -> {
		...
		this.fastForwardButton = new TransparentButton(this.client, 0, 0, 9, 9, () -> getStepSymbol(true, Screen.isControlDown()), () -> Tooltip.of(TextUtils.formatKeybindInfo(Keybinds.STEP_FORWARD, new Object[] { Keybinds.SCROLL_HUD, "scroll" })), button -> {
		...
		this.printIndicator = new TextElement(this.client, 0, 0, t -> t.add(Formatting.BOLD + "P").setWithShadow(true), () -> Tooltip.of(TextUtils.formatKeybindInfo(Keybinds.PRINT_LOGS)));
