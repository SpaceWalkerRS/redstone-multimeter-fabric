...
public class MultimeterHud extends AbstractParentElement {
	...
	public void init() {
		...
		this.fastBackwardButton = new TransparentButton(0, 0, 9, 9, () -> Texts.literal(getStepSymbol(false, Screen.isControlDown())), () -> Tooltips.keybind(Keybinds.STEP_BACKWARD, Keybinds.STEP_BACKWARD, new Object[] { Keybinds.SCROLL_HUD, "scroll" }), button -> {
		...
		this.fastForwardButton = new TransparentButton(0, 0, 9, 9, () -> Texts.literal(getStepSymbol(true, Screen.isControlDown())), () -> Tooltips.keybind(Keybinds.STEP_FORWARD, Keybinds.STEP_FORWARD, new Object[] { Keybinds.SCROLL_HUD, "scroll" }), button -> {
