...
public class ClickEvent {
	...
	public net.minecraft.network.chat.ClickEvent resolve() {
		switch (this.action) {
		case OPEN_URL:
			return new net.minecraft.network.chat.ClickEvent(net.minecraft.network.chat.ClickEvent.Action.OPEN_URL, this.value);
		case RUN_COMMAND:
			return new net.minecraft.network.chat.ClickEvent(net.minecraft.network.chat.ClickEvent.Action.RUN_COMMAND, this.value);
		case SUGGEST_COMMAND:
			return new net.minecraft.network.chat.ClickEvent(net.minecraft.network.chat.ClickEvent.Action.SUGGEST_COMMAND, this.value);
		case COPY_TO_CLIPBOARD:
			return new net.minecraft.network.chat.ClickEvent(net.minecraft.network.chat.ClickEvent.Action.COPY_TO_CLIPBOARD, this.value);
		}
