...
public class HoverEvent {
	...
	public net.minecraft.text.HoverEvent resolve() {
		switch (this.action) {
		case SHOW_TEXT:
			return new net.minecraft.text.HoverEvent(net.minecraft.text.HoverEvent.Action.SHOW_TEXT, ((Text) this.value).resolve());
		}

		throw new IllegalStateException("unable to resolve click event " + this.action.name());
	}

	public static HoverEvent resolve(net.minecraft.text.HoverEvent hoverEvent) {
		if (hoverEvent.getAction() == net.minecraft.text.HoverEvent.Action.SHOW_TEXT) {
