...
public class Style {
	...
	public void apply(net.minecraft.text.Text text) {
		if (this.color != null) {
			text.setColor(this.color.resolve());
		}
		if (this.bold != null) {
		...
		if (this.underlined != null) {
			text.setUnderlined(this.underlined);
		}
		if (this.obfuscated != null) {
			text.setObfuscated(this.obfuscated);
		}
	}

	public static Style resolve(net.minecraft.text.Text text) {
		net.minecraft.text.Formatting color = text.getColor();
		Boolean bold = text.isBold();
		Boolean italic = text.isItalic();
		Boolean underlined = text.isUnderlined();
		Boolean obfuscated = text.isObfuscated();
