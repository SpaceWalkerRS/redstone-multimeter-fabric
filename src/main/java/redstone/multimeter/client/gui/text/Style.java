...
public class Style {
	...
	public net.minecraft.network.chat.Style resolve() {
		...
		if (this.color != null) {
			style = style.withColor(this.color.resolve());
		}
		if (this.bold != null) {
			style = style.withBold(this.bold);
		}
		if (this.italic != null) {
			style = style.withItalic(this.italic);
		}
		if (this.underlined != null) {
			style = style.applyLegacyFormat(this.underlined ? ChatFormatting.UNDERLINE : null);
		}
		if (this.strikethrough != null) {
			style = style.applyLegacyFormat(this.strikethrough ? ChatFormatting.STRIKETHROUGH : null);
		}
		if (this.obfuscated != null) {
			style = style.applyLegacyFormat(this.obfuscated ? ChatFormatting.OBFUSCATED : null);
		}
		if (this.clickEvent != null) {
			style = style.withClickEvent(this.clickEvent.resolve());
		}
		if (this.hoverEvent != null) {
			style = style.withHoverEvent(this.hoverEvent.resolve());
		}
