...
public class Style {
	...
	public net.minecraft.text.Style resolve() {
		net.minecraft.text.Style style = new net.minecraft.text.Style();
	...
	public static Style resolve(net.minecraft.text.Style style) {
		...
		net.minecraft.text.Formatting color = styleAccess.rsmm$color();
		...
		net.minecraft.text.ClickEvent clickEvent = styleAccess.rsmm$clickEvent();
		net.minecraft.text.HoverEvent hoverEvent = styleAccess.rsmm$hoverEvent();
