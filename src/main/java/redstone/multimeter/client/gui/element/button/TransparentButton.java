...
public class TransparentButton extends Button {
	...
	public TransparentButton(MultimeterClient client, int x, int y, Supplier<ITextComponent> message, Supplier<Tooltip> tooltip, MousePress<Button> onPress) {
		super(client, x, y, message, tooltip, onPress);
	}
	
	public TransparentButton(MultimeterClient client, int x, int y, int width, int height, Supplier<ITextComponent> message, Supplier<Tooltip> tooltip, MousePress<Button> onPress) {
