...
public class TransparentToggleButton extends ToggleButton {
	...
	public TransparentToggleButton(MultimeterClient client, int x, int y, int width, int height, Function<Boolean, Component> text, Supplier<Boolean> getter, Consumer<Button> toggle) {
