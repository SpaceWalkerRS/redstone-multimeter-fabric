...
public class SuggestionsMenu extends AbstractElement {
	...
	public void updateSize() {
		if (this.hasEnoughSuggestions()) {
			this.size = MathHelper.clamp(this.suggestions.size(), this.minSize, this.maxSize);
	...
	public void setSelection(int index) {
		this.selected = MathHelper.clamp(index, 0, this.suggestions.size() - 1);
	...
	private void setScroll(int value) {
		...
		this.scroll = MathHelper.clamp(value, 0, this.suggestions.size() - this.size);
