...
public class ScrollableListElement extends SimpleListElement {
	...
	protected void renderList(GuiGraphics graphics, int mouseX, int mouseY) {
		...
		if (getMaxScrollAmount() > 0.0D) {
			...
			renderScrollBar(graphics, scrollMode == ScrollMode.DRAG || (isHovered() && isMouseOverScrollBar(mouseX, mouseY)));
		}
	}
	...
	protected void renderScrollBar(GuiGraphics graphics, boolean light) {
