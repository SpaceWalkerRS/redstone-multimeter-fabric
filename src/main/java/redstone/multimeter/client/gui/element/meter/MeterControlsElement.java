...
public class MeterControlsElement extends AbstractParentElement {
	...
	private void createControls() {
		...
		builder.addControl("Color", () -> new LiteralText("rgb").styled(style -> style.withColor(TextColor.fromRgb(meter.getColor()))), (client, width, height) -> new TextField(client, 0, 0, width, height, () -> null, text -> {
			try {
