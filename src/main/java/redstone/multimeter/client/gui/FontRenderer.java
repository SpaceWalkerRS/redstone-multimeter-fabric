...
public class FontRenderer {
	...
	public void draw(Text t, int x, int y) {
		this.font.draw(t.resolve().buildString(true), x, y, 0xFFFFFFFF);
	}
	...
	public void draw(Text t, int x, int y, int color) {
		this.font.draw(t.resolve().buildString(true), x, y, color);
	}
	...
	public void drawWithShadow(Text t, int x, int y) {
		this.font.drawWithShadow(t.resolve().buildString(true), x, y, 0xFFFFFFFF);
	}
	...
	public void drawWithShadow(Text t, int x, int y, int color) {
		this.font.drawWithShadow(t.resolve().buildString(true), x, y, color);
	}
