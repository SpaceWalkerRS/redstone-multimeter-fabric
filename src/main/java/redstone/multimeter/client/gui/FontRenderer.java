...
public class FontRenderer {
	...
	private static boolean fixFormattedTextWidth;

	public static boolean fixFormattedTextWidth() {
		return fixFormattedTextWidth;
	}
	...
	private int fixedWidth(String s) {
		fixFormattedTextWidth = true;
		int width = this.font.getWidth(s);
		fixFormattedTextWidth = false;
