...
public class FontRenderer {
	...
	public void draw(Text t, int x, int y) {
		this.font.draw(t.resolve().getColoredString(), x, y, 0xFFFFFFFF);
	}
	...
	public void draw(Text t, int x, int y, int color) {
		this.font.draw(t.resolve().getColoredString(), x, y, color);
	}
	...
	public void drawWithShadow(Text t, int x, int y) {
		this.font.drawShadow(t.resolve().getColoredString(), x, y, 0xFFFFFFFF);
	}
	...
	public void drawWithShadow(Text t, int x, int y, int color) {
		this.font.drawShadow(t.resolve().getColoredString(), x, y, color);
	}
