...
public class DefaultMeterPropertiesScreen extends RSMMScreen {
	...
	protected void initScreen() {
		...
		IButton clear = new Button(client, x + searchbarWidth + 2, y, 20, IButton.DEFAULT_HEIGHT, () -> new LiteralText("X"), () -> Tooltip.EMPTY, button -> {
			searchbar.clear();
			return true;
		});
		...
		SuggestionsMenu blockSuggestions = create.setSuggestions(SuggestionsProvider.resources(Block.REGISTRY, true));
