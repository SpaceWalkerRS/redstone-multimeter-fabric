...
public class Textures {
	...
	public static final Texture OPTIONS_BACKGROUND    = new Texture(new ResourceLocation("textures/gui/menu_background.png"), 16, 16);
	public static final Texture TUTORIAL_TOAST        = new Texture(new ResourceLocation("textures/gui/sprites/toast/tutorial.png"), 160, 32);
