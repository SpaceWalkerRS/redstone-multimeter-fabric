...
public class Tutorial implements TutorialListener {
	...
	private boolean isEnabled() {
		return this.client.isConnected() && this.minecraft.level != null && this.minecraft.options.tutorialStep == TutorialSteps.NONE;
	}
	...
	private void startStep() {
		if (this.toast != null) {
			this.minecraft.getToastManager().addToast(this.toast);
		}
