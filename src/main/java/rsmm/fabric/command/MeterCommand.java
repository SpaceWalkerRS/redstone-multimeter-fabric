...
public class MeterCommand {
	...
	private interface CommandExecutor {
		public void execute(MultimeterServer server, Multimeter multimeter, ServerMeterGroup meterGroup, ServerPlayerEntity player, int index, DimPos pos);
	}
	
	private interface SuggestionsProvider {
		public void addSuggestions(Collection<String> suggestions, MultimeterServer server, Multimeter multimeter, ServerMeterGroup meterGroup, int targetIndex, DimPos targetPos);
	}
